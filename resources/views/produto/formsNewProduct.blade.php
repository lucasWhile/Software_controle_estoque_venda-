        ...
        <div class="row">
            <div class="col-12">
                ...
                <form method="post" action="{{ route('product.data') }}" enctype="multipart/form-data">
                    ...
                    <div class="form-floating mb-3">
                        <input type="number" class="form-control" id="price" placeholder="Valor do produto" name="price" required>
                    ...
                    <div class="form-floating mb-3">
                        <input type="number" class="form-control" id="estoque" placeholder="Quantidade em estoque" name="amount" required> 
